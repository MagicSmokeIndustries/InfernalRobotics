...
namespace InfernalRobotics_v3.Command
{
	 ...
	 *
	 * 
	 * -->>> this class is unused in v3 -> maybe re-use/re-implement this later again
	 * 
	 */
/*
	public class Translator
	{
		...
		public float ToInternalPos(float externalPos)
		{
			if(servo.Motor.IsAxisInverted)
				return servo.MinPositionLimit + servo.MaxPositionLimit - externalPos;
			return externalPos;
		}
		...
		{
			if(servo.Motor.IsAxisInverted)
				return servo.MinPositionLimit + servo.MaxPositionLimit - internalPos;
			return internalPos;
		}
	}
*/
