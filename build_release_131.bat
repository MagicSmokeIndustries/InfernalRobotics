...
copy "InfernalRobotics\InfernalRobotics\bin\Release 1.3.1\KerbalJointReinforcement_Redist.dll" "_release\GameData131\GameData\MagicSmokeIndustries\Plugins\KerbalJointReinforcement_Redist.dll"
